...
\begin{description}
	...
	\item[Shapefile] Shapefile de la distribution des snubbies avec leurs attributs individuels (framerate: 1 year).
	\item[group composition and wanderers] Snubby number in each group and outside split by origin.

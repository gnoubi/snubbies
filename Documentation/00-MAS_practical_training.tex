...
{ \huge \bfseries Multi-agent simulation\\with Gama and R \\[0.4cm]
\Large Practical Training Manual}
...
\includegraphics[width=0.7\textwidth]{LogoSoftwares}
	...
	\fbox{
		\begin{minipage}{0.7\textwidth}
			\large \textbf{Prerequisite}: to have acquired basic notions in R (e.g. workspace, package, function, data.frame, list, etc.) and GIS (e.g. shapefile, attribute table, etc.) and corresponding skills.
		\end{minipage}
	}
\end{center}
\vfill
...
\include{01-ModelPresentation}
\include{02-GamaModel}
\include{03-Preparing}
